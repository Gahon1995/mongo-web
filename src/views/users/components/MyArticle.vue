<template>
  <div
    class="app-container"
    style="max-width: 600px; margin: 0px auto; padding: 0px"
  >
    <div align="center">
              ...
              >
                ...
                <div slot="header">
                  <el-row>
                    ...
                    >
                      <router-link :to="'/articles/edit/'+article.aid+'?category='+article.category">
                        <el-button
                          type="primary"
                          size="mini"
                        >更改</el-button>
...
export default {
  ...
  methods: {
    ...
    fetchArticles() {
      ...
      this.listQuery.authors = this.user.name
